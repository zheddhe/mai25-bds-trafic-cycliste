...
@patch("app.utils.model_logic.display_counter_metrics_table")
...
def test_display_counter_metrics_table_basic():
    metrics_table = [
        {
            "Plage": "Train",
            "R²": 0.91,
    ...
    display_counter_metrics_table(metrics_table, st_module=st_mock)

    assert st_mock.dataframe.call_count == 1


def test_display_global_metrics_table_basic():
    metrics_table = [
        {
            "R² train": 0.91,
            "RMSE train": 12.5,
    ...
    display_global_metrics_table(metrics_table, st_module=st_mock)
