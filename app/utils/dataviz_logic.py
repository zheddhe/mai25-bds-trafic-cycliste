...
@st.cache_data
def cached_load_dataset_visualization(uploaded_file):
...
def display_distrib_counting_graphics(df_raw, st_module=None):
    st = st_module or __import__("streamlit")
...
def display_average_counting_graphics(df_raw, st_module=None):
    st = st_module or __import__("streamlit")
...
def display_total_counting_graphics(df_raw, st_module=None):
    st = st_module or __import__("streamlit")
...
def display_top_sites_graphics(df_raw, st_module=None):
    st = st_module or __import__("streamlit")
...
def display_distrib_multi_level_graphics(df_raw, st_module=None):
    st = st_module or __import__("streamlit")
...
def display_sites_map_graphics(df_raw, st_module=None):
    st = st_module or __import__("streamlit")
